 ...
 *
 * The 'sw_sync' device can be opened many times as to create different
 * timelines.
 *
...
static struct sync_pt *dma_fence_to_sync_pt(struct dma_fence *fence)
{
...
MODULE_DESCRIPTION("Software Sync File Framework");
MODULE_LICENSE("GPL");
MODULE_VERSION("2.0");
