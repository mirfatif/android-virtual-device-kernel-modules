...
def _ddk_module_config_test(name, kernel_build, **private_kwargs):
    ...
    ddk_module(
        ...
        out = name + "_defconfig_only_module.ko",
        kernel_build = kernel_build,
    ...
    ddk_module(
        ...
        out = name + "_kconfig_only_module.ko",
        kernel_build = kernel_build,
    ...
    # Test that the module can be beuilt with both the defconfig and the Kconfig
    # file. The value in defconfig is used.
    write_file(
