...
#define LX_DXCREATEDEVICE _IOWR(0x47, 0x02, struct d3dkmt_createdevice)
#define LX_DXCREATECONTEXT _IOWR(0x47, 0x03, struct d3dkmt_createcontext)
#define LX_DXCREATECONTEXTVIRTUAL \
  _IOWR(0x47, 0x04, struct d3dkmt_createcontextvirtual)
#define LX_DXDESTROYCONTEXT _IOWR(0x47, 0x05, struct d3dkmt_destroycontext)
#define LX_DXCREATEALLOCATION _IOWR(0x47, 0x06, struct d3dkmt_createallocation)
...
#define LX_DXQUERYADAPTERINFO _IOWR(0x47, 0x09, struct d3dkmt_queryadapterinfo)
#define LX_DXQUERYVIDEOMEMORYINFO \
  _IOWR(0x47, 0x0a, struct d3dkmt_queryvideomemoryinfo)
#define LX_DXMAKERESIDENT _IOWR(0x47, 0x0b, struct d3dddi_makeresident)
#define LX_DXMAPGPUVIRTUALADDRESS \
  _IOWR(0x47, 0x0c, struct d3dddi_mapgpuvirtualaddress)
#define LX_DXESCAPE _IOWR(0x47, 0x0d, struct d3dkmt_escape)
#define LX_DXGETDEVICESTATE _IOWR(0x47, 0x0e, struct d3dkmt_getdevicestate)
#define LX_DXSUBMITCOMMAND _IOWR(0x47, 0x0f, struct d3dkmt_submitcommand)
...
#define LX_DXCLOSEADAPTER _IOWR(0x47, 0x15, struct d3dkmt_closeadapter)
#define LX_DXCHANGEVIDEOMEMORYRESERVATION \
  _IOWR(0x47, 0x16, struct d3dkmt_changevideomemoryreservation)
#define LX_DXCREATEHWCONTEXT _IOWR(0x47, 0x17, struct d3dkmt_createhwcontext)
#define LX_DXCREATEHWQUEUE _IOWR(0x47, 0x18, struct d3dkmt_createhwqueue)
#define LX_DXDESTROYDEVICE _IOWR(0x47, 0x19, struct d3dkmt_destroydevice)
#define LX_DXDESTROYHWCONTEXT _IOWR(0x47, 0x1a, struct d3dkmt_destroyhwcontext)
#define LX_DXDESTROYHWQUEUE _IOWR(0x47, 0x1b, struct d3dkmt_destroyhwqueue)
#define LX_DXDESTROYPAGINGQUEUE \
  _IOWR(0x47, 0x1c, struct d3dddi_destroypagingqueue)
#define LX_DXDESTROYSYNCHRONIZATIONOBJECT \
  _IOWR(0x47, 0x1d, struct d3dkmt_destroysynchronizationobject)
#define LX_DXEVICT _IOWR(0x47, 0x1e, struct d3dkmt_evict)
...
#define LX_DXINVALIDATECACHE _IOWR(0x47, 0x24, struct d3dkmt_invalidatecache)
#define LX_DXLOCK2 _IOWR(0x47, 0x25, struct d3dkmt_lock2)
#define LX_DXMARKDEVICEASERROR \
  _IOWR(0x47, 0x26, struct d3dkmt_markdeviceaserror)
#define LX_DXOFFERALLOCATIONS _IOWR(0x47, 0x27, struct d3dkmt_offerallocations)
#define LX_DXOPENRESOURCE _IOWR(0x47, 0x28, struct d3dkmt_openresource)
...
#define LX_DXRENDER _IOWR(0x47, 0x2d, struct d3dkmt_render)
...
#define LX_DXUNLOCK2 _IOWR(0x47, 0x37, struct d3dkmt_unlock2)
...
#define LX_DXENUMADAPTERS3 _IOWR(0x47, 0x3e, struct d3dkmt_enumadapters3)
#define LX_DXSHAREOBJECTS _IOWR(0x47, 0x3f, struct d3dkmt_shareobjects)
...
#define LX_DXQUERYSTATISTICS _IOWR(0x47, 0x43, struct d3dkmt_querystatistics)
...
#define LX_DXPRESENTVIRTUAL _IOWR(0x47, 0x46, struct d3dkmt_presentvirtual)
